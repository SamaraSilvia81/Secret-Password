...
let checkLower = chkLower == chkLower.checked
let checkUpper = chkUpper == chkUpper.checked
let checkNumber = chkNumber == chkNumber.checked
let checkSymbols = chkSymbols == chkSymbols.checked
...
/* 
 if(checkLower || checkUpper || checkNumber || checkSymbols){
    infoLength.innerHTML = lenInput.value;
    generatePassword(
        chkNumber.checked,
        chkSymbols.checked,
    ...
    alert("Informe os requisitos da senha!")
  }
*/